...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
      url: `https://images.hbwlife.com/wx-h5/special.html?userId=${userId}&token=${token}&isMember=${isMember}`
    })
  ...
  onShow: function () {
    ...
    var token = app.globalData.auth_token
    this.setData({
      url: `https://images.hbwlife.com/wx-h5/special.html?userId=${userId}&timestamp=${timestamp}&token=${token}&isMember=${isMember}`
    })
  },
